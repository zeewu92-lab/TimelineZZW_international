...
function WorldClockSection({ clocks, setClocks, lang, t, onHomeTzChange, part2Ref, part2Height, isDraggingWorldClock }) {
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-3">
                <button
                  ...
                  style={{ background: exportFormat === 'card' ? ACCENT : 'var(--card-border)', color: exportFormat === 'card' ? '#fff' : INK_SOFT }}
                >
                  {t.exportFormatCard}
                </button>
                <button
                  ...
                  className="flex-1 px-3 py-2 rounded-lg text-sm font-bold"
                  style={{ background: exportFormat === 'story' ? ACCENT : 'var(--card-border)', color: exportFormat === 'story' ? '#fff' : INK_SOFT }}
                >
                  {t.exportFormatStory}
                </button>
              </div>

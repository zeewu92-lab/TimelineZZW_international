...
const EVENT_MODES = [
  { id: 'birthday', labelKey: 'modeBirthday' },
  { id: 'companion', labelKey: 'modeCompanion' },
  { id: 'care', labelKey: 'modeCare' },
  { id: 'anniversary', labelKey: 'modeAnniversary' },
  { id: 'regular', labelKey: 'modeRegular' },
];
        ...
        >
          ...
          >
            ...
            <div className="p-3 rounded-xl" style={{ border: CARD_BORDER, background: INPUT_BG }}>
                ...
                {EVENT_MODES.map(m => {
                  ...
                  return (
                    <button
                      ...
                      style={{
                        background: active ? ACCENT : 'var(--card-border)',
              ...
              {eventMode === 'birthday' && <p className="text-xs mt-2" style={{ color: INK_SOFT }}>{t.birthdayHint}</p>}
              {eventMode === 'care' && <p className="text-xs mt-2" style={{ color: INK_SOFT }}>{t.careHint}</p>}
            </div>

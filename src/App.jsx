...
import { Plus, Trash2, ChevronDown, ChevronLeft, X, MapPin, Check, Clock, Globe, Sun, Moon, Pencil, User, LogOut, Mail, Eye, EyeOff, Search, SlidersHorizontal } from 'lucide-react';
import {
    ...
    >
      ...
      >
        ...
        <div className="relative w-full max-h-[85vh] overflow-y-auto rounded-3xl p-5 flex flex-col" style={{ ...AUTH_GLASS, background: `rgba(255,255,255,${bgOpacity})`, zIndex: 1 }}>
          ...
          {/* 匯出成圖片：用 Canvas 手繪整張卡片（不依賴 DOM 截圖），使用者可自選輸出比例 */}
          <div className="mt-5 pt-4" style={{ borderTop: CARD_BORDER }}>

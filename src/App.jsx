...
function LandmarkDetailModal({ ev, lang, t, onClose, onSetBgImage }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative w-full max-h-[85vh] overflow-y-auto rounded-3xl p-5 flex flex-col" style={{ ...AUTH_GLASS, zIndex: 1 }}>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              <div className="inline-block px-3 py-1 rounded-lg text-sm font-bold" style={{ background: `${colorHex(ev.colorId)}20`, color: colorHex(ev.colorId) }}>
                {ev.diffDays === 0 ? t.today : ev.diffDays > 0 ? `${ev.diffDays} Days Left` : `${Math.abs(ev.diffDays)} Days Ago`}
              </div>
              {ev.age !== null && (
            ...
            <div className="flex items-center gap-3 flex-wrap">
              <div className="flex items-center gap-1.5 text-xs font-bold" style={{ color: INK_SOFT }}>
                <span className="w-3.5 h-3.5 rounded-full flex-shrink-0" style={{ background: colorHex(ev.colorId) }} />
                {t.markerColorLabel}
              </div>
              {ev.isBirthday && (
                <span className="text-xs font-bold px-2 py-0.5 rounded-full" style={{ background: `${ACCENT}20`, color: ACCENT }}>{t.birthdayLabel}</span>
              )}
              {ev.isCare && (
          ...
          <div className="mt-5 pt-4" style={{ borderTop: CARD_BORDER }}>
            ...
            <p className="text-xs mt-2" style={{ color: INK_SOFT }}>{t.customBgHint}</p>
          </div>
        </div>
      </div>
    </div>

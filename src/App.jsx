  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className={dock ? 'relative w-full h-full overflow-y-auto rounded-3xl p-5 flex flex-col' : 'relative w-full max-h-[85vh] overflow-y-auto rounded-3xl p-5 flex flex-col'} style={{ ...AUTH_GLASS, background: `rgba(255,255,255,${bgOpacity})`, zIndex: 1, overscrollBehavior: 'contain', touchAction: 'pan-y' }}>
          ...
          <div className="flex flex-col items-center justify-center relative" style={{ zIndex: 1, padding: '26px 0' }}>
            <div
              style={{
                fontSize: 'clamp(76px, 19vw, 128px)',
                lineHeight: 0.85,
                fontWeight: 500,
          ...
          <div className="mt-5 pt-4 flex items-center gap-2 relative" style={{ borderTop: CARD_BORDER, zIndex: 1 }}>
            <button
              ...
              style={{ background: showCustomizePanel ? ACCENT : 'var(--card-border)', color: showCustomizePanel ? '#fff' : INK_SOFT }}
            >
              <Settings size={15} />
              {t.customizeLabel}
            </button>
          ...
          <div
            ...
            style={{
              ...
              overflow: 'hidden',
              transition: 'max-height 0.36s ease, opacity 0.3s ease, margin-top 0.32s ease',
            }}
          >
            ...
            {/* 更換數字字體：欄位先加上，實際可選的字體樣式之後再另外討論／實作 */}
            <div className="pt-4">
              <div className="text-xs font-bold mb-2" style={{ color: INK_SOFT }}>{t.customFontLabel}</div>
              <div className="flex items-center gap-2">
                {[0, 1, 2].map(i => (
                  <div
                    key={i}
                    className="flex items-center justify-center rounded-lg flex-shrink-0"
                    style={{ width: 52, height: 52, background: CARD_BG, border: CARD_BORDER, color: INK_SOFT, fontSize: 20, fontWeight: 600, opacity: 0.45 }}
                  >
                    Aa
                  </div>
                ))}
              </div>
              <p className="text-xs mt-2" style={{ color: INK_SOFT }}>{t.customFontComingSoon}</p>
            </div>
          </div>

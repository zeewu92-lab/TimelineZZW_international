...
function LandmarkDetailModal({ ev, lang, t, onClose, onSetBgImage, onSetBgOpacity }) {
...
function TimelineSection({ events, setEvents, lang, t, now, customIcons, setCustomIcons, onHeaderDragStart, onHeaderDragMove, onHeaderDragEnd }) {
